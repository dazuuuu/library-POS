...
function audit_product_view(array $r, array $catName): array
{
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $in = [
        ...
        'category_id'         => (int) $C->findOrCreate($_POST['category'] ?? '', 'subject'),
        'grade_id'            => 0,
        'publisher_id'        => 0,
        'author_id'           => 0,
        'edition_id'          => 0,
    ...
    if (!$errors) {
        ...
        if ($res['ok']) {
            try {
                $before = audit_product_view($beforeRow, $catName);
                $after  = audit_product_view($in, $catName);
      ...
      <div class="card-body p-4">
        ...
        <form method="post" enctype="multipart/form-data" novalidate>
          ...
          <div class="mb-3">
            ...
            <input name="name" class="form-control" value="<?php echo htmlspecialchars($val('name')); ?>" placeholder="e.g. Maize flour 2kg" required>
          ...
          <div class="row g-2">
            <div class="col-6 mb-3">
              ...
              <div class="ta-wrap">
                <input type="text" name="category" class="form-control ta-input" data-field="category" value="<?php echo htmlspecialchars($textVal('category', 'category_name')); ?>" placeholder="e.g. Groceries" autocomplete="off">
            ...
            <div class="col-6 mb-3">
              ...
              <div class="ta-wrap">
                <input type="text" name="supplier" class="form-control ta-input" data-field="supplier" value="<?php echo htmlspecialchars($textVal('supplier', 'supplier_name')); ?>" placeholder="e.g. Main distributor" autocomplete="off">
                <div class="ta-menu"></div>
              </div>
            </div>
          </div>
...
<script>
  // Free-text type-ahead for Category/Supplier —
