...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .logo-icon{width:56px;height:56px;border-radius:14px;overflow:hidden;background:var(--pos-red-light);
                   border:1px solid #f3d3d3;display:inline-flex;align-items:center;justify-content:center;margin-bottom:12px}
        .logo-icon img{width:100%;height:100%;object-fit:contain}
        .logo-icon i{color:var(--pos-red);font-size:22px}
        ...
        .form-control:focus{border-color:var(--pos-red)!important;box-shadow:0 0 0 .2rem rgba(220,38,38,.1)!important}
        .field-focus-line{display:none}

        .btn-auth{width:100%;padding:13px;font-weight:700;font-size:.95rem;
                  background:var(--pos-red)!important;border:none!important;border-radius:12px!important;
                  color:#fff!important;letter-spacing:.02em;transition:background .15s!important}
        .btn-auth:hover{background:var(--pos-red-dark)!important}
        ...
        .auth-foot a{color:var(--pos-red);text-decoration:none;font-weight:600}
